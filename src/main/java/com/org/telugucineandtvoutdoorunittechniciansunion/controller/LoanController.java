    ...
    try {
      ...
      if (obj != null) {
        ...
        if (topPanelresultCode != null && !"".equalsIgnoreCase(topPanelresultCode) && 
          ...
          LoanRecoveryDetails loanRecoveryDetails = this.loanService.getLoanRecoveryDetails(memberId, transId, loanId);
          if (loanRecoveryDetails != null)
          {
            model.put("PAID_DATE", (new SimpleDateFormat("dd/MM/yyyy")).format(loanRecoveryDetails.getPaidDate()));
